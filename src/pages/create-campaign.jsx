  ...
  >
    <div className="flex items-start space-x-4">
      ...
      <div className="flex-1">
        ...
        {/* New Textbox Below */}
        <textarea
          placeholder={`Talk to ${reaction.name}`}
          className="w-full mt-4 p-2 bg-white/5 text-gray-300 border border-white/10 rounded-lg focus:outline-none focus:ring-2 focus:ring-purple-500 resize-none"
          rows="3"
        />
      </div>
    </div>
...
export default function CreateCampaign() {
  ...
  const [analyticsImported,setanalyticsImported] = useState(false);

  const tabs = [
    { name: 'Create Digital Personas', step: 1 },
    { name: 'Input Campaign', step: 2 },
